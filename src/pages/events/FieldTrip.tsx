...
import bg from "../../images/events/ft/bg-ft.png"
import logo from "../../images/events/ft/logo-ft.png"
import images from "../../images/events/ft/images-ft.png"
import desc from "../../images/events/ft/desc-ft.png"
import Aos from "aos"
            ...
            >
                ...
                >
                    ...
                    <div className="mt-10 flex flex-col md:flex-row items-stretch gap-5 w-full">
                        ...
                        >
                            <p className="text-xl text-white font-inter">Introduce participants to <span className="font-semibold">real oil and gas field operations</span></p>
                        </div>
                        ...
                        <div
                            ...
                            className="glass flex items-center justify-center text-center px-12 py-8"
                        >
                            <p className="text-xl text-white font-inter">Expand participants’ understanding of <span className="font-semibold">industrial practices and safety culture</span></p>
                        </div>
                        ...
                        <div
                            ...
                            className="glass flex items-center justify-center text-center px-12 py-8"
                        >
                            <p className="text-xl text-white font-inter">Provide <span className="font-semibold">hands-on learning experiences</span> beyond academic studies</p>
                        </div>
                    </div>
                </div>
                ...
                >
                    <div className="px-5 md:px-20 lg:px-32 rotate-0 md:-rotate-6">
                        <p className="font-bold text-3xl font-inter text-white">Looking back on Last Year’s: <span className="font-semibold italic font-garamond text-[#E7C66B]">Field Trip</span></p>

                        <p className="font-inter text-white text-2xl mt-5">Field Trip 2025 successfully brought participants to visit <span className="font-semibold">Baker Hughes</span>, where they <span className="font-semibold">explored real industry operations</span>, gained valuable insights, and <span className="font-semibold">experienced the professional working environment firsthand.</span>
                        </p>

                        <p className="mt-10 font-garamond italic font-semibold text-white text-xl">Ready for another exciting industrial journey at Field Trip 2026? See you there!</p>
                    </div>
