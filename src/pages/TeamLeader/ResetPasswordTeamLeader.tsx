    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const res = await fetch(
                `${import.meta.env.VITE_API_BASE_URL}/team-leader/reset-password/${token}`,
                {
                    method: "POST",
                    headers: {
...
export default ResetPasswordTeamLeader