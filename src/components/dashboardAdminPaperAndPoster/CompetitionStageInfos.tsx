        ...
        try {
            ...
            const mudInnovation = competitions.find((competition) =>
                competition.name_competition
                    ?.toLowerCase()
                    .includes("paper & poster"),
            )

            if (!mudInnovation) {
                setToast({
                    message: "Paper and Poster competition not found.",
                    type: "error",
                })
                return
            }
            ...
            setToast({
                message:
                    error instanceof Error
                        ? error.message
                        : "Failed to fetch Paper and Poster competition.",
                type: "error",
            })
        } finally {
            setIsLoading(false)
