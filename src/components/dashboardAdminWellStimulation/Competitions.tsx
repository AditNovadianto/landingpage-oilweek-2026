...
const Competitions = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setToast({
                message: "Well Stimulation Competition updated successfully.",
                type: "success",
            })
        ...
        <div className="text-white space-y-6 px-10 py-7">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="glass p-5 rounded-2xl">
                    ...
                    <p className="text-3xl font-bold mt-1">
                        {wellStimulationCompetition ? 1 : 0}
                    </p>
                </div>
                ...
                <div className="glass p-5 rounded-2xl">
                    ...
                    <p className="text-3xl font-bold mt-1">
                        {wellStimulationCompetition?.status_competition || "-"}
                    </p>
                </div>
                ...
                <div className="glass p-5 rounded-2xl">
                    ...
                    <p className="text-3xl font-bold mt-1">
                        {wellStimulationCompetition?.id_platform || "-"}
                    </p>
                </div>
            </div>
            ...
            <div className="glass p-5 rounded-2xl">
                <div className="flex items-center justify-between mb-5">
                    <div>
                        ...
                        <p className="text-sm opacity-70">
                            Detail competition assigned to Well Stimulation Admin.
                        </p>
                    </div>
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-sm">
                        ...
                        <tbody>
                            {wellStimulationCompetition && (
                                <tr
                                    key={wellStimulationCompetition.id_competition}
                                ...
                                >
                                    ...
                                    <td className="py-3">
                                        <span
                                            className={`px-3 py-1 rounded-full text-xs ${wellStimulationCompetition.status_competition ===
                                                "ACTIVE"
                    ...
                    {!isLoading && !wellStimulationCompetition && (
                        <p className="text-center text-sm opacity-70 py-6">
                            Well Stimulation Competition data not found.
                        </p>
                    )}
                    ...
                    <div className="glass p-6 rounded-2xl w-full max-w-md">
                        <div className="flex items-center justify-between mb-5">
                            <p className="text-xl font-semibold">
                                Edit Well Stimulation Competition
                            </p>
