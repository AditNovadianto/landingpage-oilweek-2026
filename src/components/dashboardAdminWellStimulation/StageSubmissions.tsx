...
const StageSubmissions = () => {
    ...
    const getTeamName = (id_team: number | string) => {
        ...
        return team?.team_name || team?.name_team || `Team ${id_team}`
    }
    ...
    const getSubmissionFile = (submission: StageSubmission) => {
        return submission.submission_link || submission.submission_file || ""
    }
        ...
        <div className="text-white space-y-6 px-10 py-7">
            <div>
                <p className="text-2xl font-bold italic">
                    Well Stimulation Stage Submissions
                </p>
                <p className="text-sm opacity-70 mt-1">
                    View and manage team submissions for each Well Stimulation
                    stage.
                </p>
            </div>
                    ...
                    <div className="glass p-6 rounded-2xl w-full max-w-3xl">
                        ...
                        <div className="mt-5">
                            <FileBox
                                ...
                                value={getSubmissionFile(selectedSubmission)}
