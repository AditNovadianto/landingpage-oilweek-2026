...
const TeamLeaders = () => {
    ...
    const WELL_STIMULATION_KEYWORD = "well stimulation"
    ...
    const filteredTeamLeaders = useMemo(() => {
        ...
        return wellStimulationTeamLeaders.filter((leader) => {
            return (
    ...
    }, [wellStimulationTeamLeaders, search])
    ...
    }, [allMembers, wellStimulationTeams])

    const openDetailModal = (leader: TeamLeader) => {
        const team =
            wellStimulationTeams.find(
                (item) =>
        ...
        <div className="text-white space-y-6 px-10 py-7">
            <div>
                <p className="text-2xl font-bold italic">
                    Well Stimulation Team Leader Management
                </p>
                <p className="text-sm opacity-70 mt-1">
                    View team leaders, teams, and members registered in Well Stimulation Competition only.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="glass p-5 rounded-2xl">
                    ...
                    <p className="text-3xl font-bold mt-1">
                        {wellStimulationTeamLeaders.length}
                    </p>
                </div>
            ...
            <div className="glass p-5 rounded-2xl">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-5">
                    <div>
                        <p className="font-semibold text-lg">
                            Well Stimulation Team Leader List
                        </p>
                        <p className="text-sm opacity-70">
                            List of team leaders registered in Well Stimulation
                            Competition.
                        </p>
                    </div>
                ...
                <div className="overflow-x-auto">
                    ...
                    {!isLoading && filteredTeamLeaders.length === 0 && (
                        <p className="text-center text-sm opacity-70 py-6">
                            No Well Stimulation team leader data found.
                        </p>
                    )}
                </div>
            </div>
                ...
                <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 px-5">
                    <div className="glass p-6 rounded-2xl w-full max-w-6xl max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="glass p-5 rounded-2xl mt-5">
                            <p className="font-semibold text-lg mb-4">
                                Well Stimulation Team Information
                            </p>
