...
const Registrations = () => {
    ...
    const filteredRegistrations = useMemo(() => {
        ...
        return caseStudyRegistrations.filter((registration) => {
            return (
    ...
    }, [caseStudyRegistrations, search, teams, teamLeaders])

    const approvedPayments = caseStudyRegistrations.filter(
        (item) => item.payment_status === "APPROVED"
    ).length

    const pendingPayments = caseStudyRegistrations.filter(
        (item) => item.payment_status === "PENDING"
    ).length

    const activeRegistrations = caseStudyRegistrations.filter(
        ...
        <div className="text-white space-y-6 px-10 py-7">
            <div>
                ...
                <p className="text-sm opacity-70 mt-1">
                    Manage registrations and verify payment status for Case
            ...
            <div className="glass p-5 rounded-2xl">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-5">
                    <div>
                        <p className="font-semibold text-lg">
                            Case Study Registration List
                        </p>
                        <p className="text-sm opacity-70">
                            List of team leaders who registered for Case Study
                            Competition.
                        </p>
                    </div>
                ...
                <div className="overflow-x-auto">
                    ...
                    {!isLoading && filteredRegistrations.length === 0 && (
                        <p className="text-center text-sm opacity-70 py-6">
                            No Case Study registration data found.
                        </p>
                    )}
                </div>
            </div>
