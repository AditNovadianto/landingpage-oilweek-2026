...
const Competitions = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setToast({
                message: "Mud Innovation Competition updated successfully.",
                type: "success",
            })
        ...
        <div className="text-white space-y-6 px-10 py-7">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="glass p-5 rounded-2xl">
                    ...
                    <p className="text-3xl font-bold mt-1">
                        {mudInnovationCompetition?.status_competition || "-"}
                    </p>
                </div>
                ...
                <div className="glass p-5 rounded-2xl">
                    ...
                    <p className="text-3xl font-bold mt-1">
                        {mudInnovationCompetition?.id_platform || "-"}
                    </p>
                </div>
            </div>
            ...
            <div className="glass p-5 rounded-2xl">
                <div className="flex items-center justify-between mb-5">
                    <div>
                        ...
                        <p className="text-sm opacity-70">
                            Detail competition assigned to Mud Innovation Admin.
                        </p>
                    </div>
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-sm">
                        ...
                        <tbody>
                            {mudInnovationCompetition && (
                                <tr
                                    key={mudInnovationCompetition.id_competition}
                                ...
                                >
                                    ...
                                    <td className="py-3">
                                        <span
                                            className={`px-3 py-1 rounded-full text-xs ${mudInnovationCompetition.status_competition ===
                                                    "ACTIVE"
                    ...
                    {!isLoading && !mudInnovationCompetition && (
                        <p className="text-center text-sm opacity-70 py-6">
                            Mud Innovation Competition data not found.
                        </p>
                    )}
                    ...
                    <div className="glass p-6 rounded-2xl w-full max-w-md">
                        <div className="flex items-center justify-between mb-5">
                            <p className="text-xl font-semibold">
                                Edit Mud Innovation Competition
                            </p>
