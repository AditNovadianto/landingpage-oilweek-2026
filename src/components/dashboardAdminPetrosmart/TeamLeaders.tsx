...
const TeamLeaders = () => {
    ...
    const filteredTeamLeaders = useMemo(() => {
        ...
        return petrosmartTeamLeaders.filter((leader) => {
            return (
    ...
    }, [allMembers, petrosmartTeams])

    const openDetailModal = (leader: TeamLeader) => {
        const team =
            petrosmartTeams.find(
        ...
        <div className="text-white space-y-6 px-10 py-7">
            <div>
                <p className="text-2xl font-bold italic">
                    Petrosmart Team Leader Management
                </p>
                <p className="text-sm opacity-70 mt-1">
                    View team leaders, teams, and members registered in Petrosmart Competition only.
                </p>
            </div>
            ...
            <div className="glass p-5 rounded-2xl">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-5">
                    <div>
                        <p className="font-semibold text-lg">
                            Petrosmart Team Leader List
                        </p>
                        <p className="text-sm opacity-70">
                            List of team leaders registered in Petrosmart
                            Competition.
                        </p>
                    </div>
                ...
                <div className="overflow-x-auto">
                    ...
                    {!isLoading && filteredTeamLeaders.length === 0 && (
                        <p className="text-center text-sm opacity-70 py-6">
                            No Petrosmart team leader data found.
                        </p>
                    )}
                </div>
            </div>
