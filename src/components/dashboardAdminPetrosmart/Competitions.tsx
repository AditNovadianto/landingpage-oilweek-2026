...
const Competitions = () => {
    ...
    const normalizeCompetitions = (data: any): Competition[] => {
    ...
    const fetchCompetitions = async () => {
        try {
            ...
            setCompetitions(normalizeCompetitions(data))
        } catch (error) {
            console.error(error)
            setToast({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setToast({
                message: "Petrosmart Competition updated successfully.",
                type: "success",
            })
        ...
        <div className="text-white space-y-6 px-10 py-7">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm opacity-70 mt-1">
                        Manage your assigned Petrosmart competition data and
                        availability.
                    </p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="glass p-5 rounded-2xl">
                    ...
                    <p className="text-3xl font-bold mt-1">
                        {petrosmartCompetition?.status_competition || "-"}
                    </p>
                </div>
                ...
                <div className="glass p-5 rounded-2xl">
                    ...
                    <p className="text-3xl font-bold mt-1">
                        {petrosmartCompetition?.id_platform || "-"}
                    </p>
                </div>
            </div>
            ...
            <div className="glass p-5 rounded-2xl">
                <div className="flex items-center justify-between mb-5">
                    <div>
                        ...
                        <p className="text-sm opacity-70">
                            Detail competition assigned to Petrosmart Admin.
                        </p>
                    </div>
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-sm">
                        ...
                        <tbody>
                            {petrosmartCompetition && (
                                <tr
                                    key={petrosmartCompetition.id_competition}
                                ...
                                >
                                    ...
                                    <td className="py-3">
                                        <span
                                            className={`px-3 py-1 rounded-full text-xs ${petrosmartCompetition.status_competition ===
                                                    "ACTIVE"
                    ...
                    {!isLoading && !petrosmartCompetition && (
                        <p className="text-center text-sm opacity-70 py-6">
                            Petrosmart Competition data not found.
                        </p>
                    )}
