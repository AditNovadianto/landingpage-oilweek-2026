...
const AboutOilWeek = () => {
    ...
    return (
        <div
            id="aboutoilweek"
            className="mt-10 px-5 md:px-20 lg:px-32 py-10 min-h-screen flex items-center justify-between"
        >
            <div
                className="glass px-14 py-10 w-full lg:w-[50%] md:m-auto lg:m-0"
                data-aos="fade-up"
