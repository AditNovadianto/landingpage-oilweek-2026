    ...
    return (
        <div className="px-5 md:px-20 lg:px-32 pb-10 mt-32 md:mt-0 md:min-h-screen flex flex-col items-center justify-center">
            <p
                ...
                data-aos="fade-up"
            >
                Are You <span className="font-bold">Ready</span> to <span className="italic font-garamond text-[#E7C66B] font-semibold">#Lead The Shift</span> <span className="font-bold">?</span>
            </p>

            <p
                className="mt-10 font-inter font-light text-white text-lg md:text-2xl lg:text-3xl text-center"
                data-aos="fade-up"
                data-aos-delay="200"
            >
