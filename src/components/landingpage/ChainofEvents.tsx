    ...
    return (
        <div className="mt-10 px-7 md:px-20 lg:px-32 py-10 min-h-screen">
            <div data-aos="fade-right" className="text-white mt-10 md:mt-40">
                ...
                <p className="text-3xl font-garamond font-light">of Events <span className="m-auto inline-block align-middle w-10 h-1 bg-linear-to-b from-yellow-400 via-yellow-200 to-white"></span></p>
            </div>
            ...
            <div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-10">
                <div data-aos="fade-up" data-aos-delay="100" className="glass py-5 relative pb-24">
                    ...
                    <div className="absolute -bottom-5 -left-5 flex items-center gap-3 w-[90%]">
                        ...
                        <div className="flex items-center gap-3 flex-1">
                            <p className="italic text-2xl font-garamond text-white whitespace-nowrap">
                                Pre Event
                            </p>

                            <span className="flex-1 h-1 rounded-full bg-linear-to-r from-[#B8860B] via-[#FFD700] to-white"></span>
                        </div>
                    </div>
                ...
                <div data-aos="fade-up" data-aos-delay="200" className="glass py-5 relative pb-24">
                    ...
                    <div className="absolute w-[90%] -bottom-5 -left-5 flex items-center md:items-start gap-3">
                        ...
                        <div className="flex items-center gap-3 flex-1">
                            <p className="italic text-2xl font-garamond text-white">
                                Grand Seminar X Skill Finder
                            </p>

                            <span className="w-32 h-1 rounded-full bg-linear-to-r from-[#B8860B] via-[#FFD700] to-white"></span>
                        </div>
                    </div>
