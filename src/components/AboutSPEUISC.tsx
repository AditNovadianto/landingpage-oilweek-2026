...
const AboutSPEUISC = () => {
    return (
        <div id='aboutspeuisc' className='px-32 py-10 min-h-screen border border-red-500 flex items-center gap-20 justify-between mt-10'>
            <img className='w-75' src={heroImageAboutSPEUISC} alt="About SPEUISC" />

            <div className='text-white text-left'>
                <p className='text-5xl font-inter font-light'>About <span className='italic font-garamond font-semibold'>SPE UI SC</span></p>
                ...
                <div className='flex items-center gap-10 mt-10 justify-between'>
